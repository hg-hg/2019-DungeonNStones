...
QT_MOC_LITERAL(3, 15, 6), // "Stone*"
QT_MOC_LITERAL(4, 22, 2) // "me"

    },
    "Stone\0clicked\0\0Stone*\0me"
};
...
void Stone::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->clicked((*reinterpret_cast< Stone*(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            using _t = void (Stone::*)(Stone * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Stone::clicked)) {
                *result = 0;
                return;
            }
        }

...
QT_MOC_LITERAL(6, 39, 12), // "clickedStone"
QT_MOC_LITERAL(7, 52, 6), // "Stone*"
QT_MOC_LITERAL(8, 59, 5), // "stone"
QT_MOC_LITERAL(9, 65, 21), // "animateCrushingStones"
QT_MOC_LITERAL(10, 87, 7), // "endMove"
QT_MOC_LITERAL(11, 95, 7), // "gravity"
QT_MOC_LITERAL(12, 103, 15) // "gravityFinished"

    },
    "GameBoard\0stonesCrushing\0\0hp\0damage\0"
    "mp\0clickedStone\0Stone*\0stone\0"
    "animateCrushingStones\0endMove\0gravity\0"
    "gravityFinished"
};
...
void GameBoard::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->clickedStone((*reinterpret_cast< Stone*(*)>(_a[1]))); break;
        case 2: _t->animateCrushingStones(); break;
        case 3: _t->endMove(); break;
        case 4: _t->gravity(); break;
        case 5: _t->gravityFinished(); break;
        default: ;
        }
